...
#currently: grid_with_residents_20201207_30min
...
DROP TABLE IF EXISTS grid_with_residents_20201207_30min_car_hex; -- delete old table
...
INTO grid_with_residents_20201207_30min_car_hex
...
st_centroid(geom), random_between(0,100), random_between(0,100)), 4326))
                            ...
                            residents_in_30min FROM grid_with_residents_20201207_30min_car_hex 
...
UPDATE grid_with_residents_20201207_30min_car_hex
SET residents_in_30min = isochrones_car.residents
FROM isochrones_car
WHERE grid_with_residents_20201207_30min_car_hex.id = isochrones_car.id;"
...
DROP TABLE IF EXISTS grid_with_residents_20201207_30min_pt_hex; -- delete old table
-- JOIN: add residents within 30-min-isochrone to hexgrid_1500 in column residents_in_30min (by ID)
SELECT g.id, g.geom, p.residents AS residents_in_30min
INTO grid_with_residents_20201207_30min_pt_hex
...
st_centroid(geom), random_between(-750,750), random_between(-750,750)), 4326))
                            AS centroid, st_asgeojson(st_transform(geom, 4326)) AS cell, 
                            residents_in_30min FROM grid_with_residents_20201207_30min_pt_hex 
                               WHERE residents_in_30min = 0") #%>% top_n(100)
...
-- DROP TABLE IF EXISTS grid_with_residents_20201207_30min_pt_hex2; -- delete old table
-- JOIN: add residents within 30-min-isochrone to hexgrid_1500 in column residents_in_30min (by ID)
-- SELECT g.id, g.geom, p.residents AS residents_in_30min
-- INTO grid_with_residents_20201207_30min_pt_hex2
--    FROM isochrones_pt AS p, hexgrid_1500 AS g
--    WHERE g.id = p.id;

UPDATE grid_with_residents_20201207_30min_pt_hex
SET residents_in_30min = isochrones_pt.residents
FROM isochrones_pt
WHERE grid_with_residents_20201207_30min_pt_hex.id = isochrones_pt.id;"
...
DROP TABLE IF EXISTS grid_with_residents_20201207_30min_bike_hex; -- delete old table
-- JOIN: add residents within 30-min-isochrone to hexgrid_1500 in column residents_in_30min (by ID)
SELECT g.id, g.geom, p.residents AS residents_in_30min
INTO grid_with_residents_20201207_30min_bike_hex
...
DROP TABLE IF EXISTS grid_with_residents_20201207_30min_ptbike_hex; -- delete old table
-- JOIN: add residents within 30-min-isochrone to hexgrid_1500 in column residents_in_30min (by ID)
SELECT g.id, g.geom, p.residents AS residents_in_30min
INTO grid_with_residents_20201207_30min_ptbike_hex
...
DROP TABLE IF EXISTS grid_with_residents_20201207_30min_bikeride_hex; -- delete old table
-- JOIN: add residents within 30-min-isochrone to hexgrid_1500 in column residents_in_30min (by ID)
SELECT g.id, g.geom, p.residents AS residents_in_30min
INTO grid_with_residents_20201207_30min_bikeride_hex
